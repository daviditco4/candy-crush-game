...
public class MoveMaker {
	...
	private void initMap(){
		...
		map.put(new Candy().getKey() + new CandyTimeBonus().getKey(), new CandyMove(grid));
		...
		map.put(new HorizontalStripedCandy().getKey() + new CandyTimeBonus().getKey(), new CandyMove(grid));
		...
		map.put(new VerticalStripedCandy().getKey() + new CandyTimeBonus().getKey(), new CandyMove(grid));
		...
		map.put(new WrappedCandy().getKey() + new CandyTimeBonus().getKey(), new CandyMove(grid));
		...
		map.put(new Bomb().getKey() + new CandyTimeBonus().getKey(), new BombMove(grid));

		map.put(new CandyTimeBonus().getKey() + new Candy().getKey(), new CandyMove(grid));
		map.put(new CandyTimeBonus().getKey() + new HorizontalStripedCandy().getKey(), new CandyMove(grid));
		map.put(new CandyTimeBonus().getKey() + new VerticalStripedCandy().getKey(), new CandyMove(grid));
		map.put(new CandyTimeBonus().getKey() + new WrappedCandy().getKey(), new CandyMove(grid));
		map.put(new CandyTimeBonus().getKey() + new Bomb().getKey(), new BombMove(grid));
		map.put(new CandyTimeBonus().getKey() + new CandyTimeBonus().getKey(), new CandyMove(grid));
	}
